...
#[function_component(TelInput)]
pub fn tel_input(props: &Props) -> Html {
    ...
    html! {
        <input type="tel" name={props.name.clone()} placeholder={props.placeholder.clone()} onchange={onchange}/>
    }
}
